...
class BootstrapExtension extends AbstractExtension
{
    ...
    public function getFunctions()
    {
        return [
            ...
            new TwigFunction('table_time', [$this, 'tabletimeFunction'], ['is_safe' => ['html']]),
            new TwigFunction('table_slot', [$this, 'tableslotFunction'], ['is_safe' => ['html']]),
        ];
    }
     ...
     * @return string
     */
    public function tabletimeFunction($month, $year)
    {
        return $this->tableRenderer->renderBuildcalendar($month, $year);
    }
     ...
     * @return string
     */
    public function tableslotFunction($duration, $cleanup, $start, $end)
    {
        return $this->tableRenderer->renderTimeslots($duration, $cleanup, $start, $end);
    }
